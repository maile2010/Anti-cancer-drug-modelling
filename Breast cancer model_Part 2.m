%This code is used to answer question 5 in the Assignment 1
% Question 5: Define a research question and investigate it using the above mathematical model
% of cancer growth.
...
if isempty(Thresbool)
    T_thres_pass = 0; %threshold never reached -> put line at 0
else
...
%dx(1) = - dd*D - bk*C*D*(E/EM); %D single dose
dx(1) = 0; %D steady administration
dx(2) = (lambda.ce*E)*C*(1 - C/CM) - dc*C - 500*b*D*C*(E/EM); %C
...
dx(4) = - db*A - uBk*V*A; %A
dx(5) = (lambda.e)*E*(1 - E/EM) - de*E + k*V; %E
end